...
document.addEventListener('DOMContentLoaded',function(){
  ...
  function setLang(l){
    ...
    document.title=l==='ja'?'NOMADO合同会社 | 日本とニュージーランドのウェディング・写真・不動産撮影':'Nomado | Destination weddings, photography and property media across Japan and New Zealand';
  }
  ...
  const sunEl=document.getElementById('sunwrap'),me=document.querySelector('.me')||document.createElement('div');
